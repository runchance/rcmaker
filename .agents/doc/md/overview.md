...
rcmaker 采用 Apache License 2.0，框架可以免费用于个人、团队和商业项目。源码在 [GitHub](https://github.com/runchance/rcmaker)，欢迎 Star。
...
| AI 开发 Skill | 附带框架规范、本地文档和 Agent 入口，帮助 AI 复用已有能力 |
...
| 下载独立 PHP CLI | [独立 PHP CLI 下载](md/download.md) |
| 构建、加密、注册服务和生成签名密钥（推荐） | [交互式项目工具](md/interact.md) |
...
| 配置应用独立进程组 | [应用进程组](md/app-process.md) |
| 传统参数脚本（兼容备选，随时可能删除） | [备选脚本说明](md/scripts/buildBin.md) |
...
- 详细手册见：[rcmaker 文档](https://rcmaker.runchance.com/doc/)
...
![](../benchmarks/workerman.png)

ab

![](../benchmarks/ab_cli_workerman.png)

autocannon

![](../benchmarks/cli_workerman.png)

**CLI 模式无业务压测**
**[swoole]**

![](../benchmarks/swoole.png)

ab

![](../benchmarks/ab_cli_swoole.png)

autocannon

![](../benchmarks/cli_swoole.png)
